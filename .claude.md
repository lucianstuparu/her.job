...
## Purpose
Personal knowledge repository for peacebuilding research, citations, thoughts, and ideas.
...
```
#add-note trauma:
Interesting connection between collective trauma and community resilience - need to explore this further
```
